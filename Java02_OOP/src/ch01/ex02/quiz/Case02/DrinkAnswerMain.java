...
public class DrinkAnswerMain {
	...
	public static void main(String[] args) {
		...
		//DrinkAnswer class 배열 생성하기 
		DrinkAnswer[] d = new DrinkAnswer[drinkCnt];
		// 주문 시 사용 할 요금 저장 배열 
		...
		while(true) {
			...
			case 1:
				...
				for(int i=0; i<drinkCnt;i++) {
					System.out.println((i+1)+". "+d[i].name+ " : "+ pay[i]+"원");
				}
			...
			case 2:
				...
				for(int i=0; i<drinkCnt; i++) {
					System.out.println((i+1)+". "+d[i].name+": "+cnt[i]);
			...
			case 3: 
				...
				for(DrinkAnswer i : d) {
					...
					System.out.println("총 판매 금액 : "+i.sumPay);
					System.out.println("총 판매 수량 : "+i.sumCnt);
				}
				break;
			default:
